...
public:
	TECS() :
		...
		_pitch_dem(0.0f),
		_integ1_state(0.0f),
		_integ2_state(0.0f),  //高度变化速率
		_integ3_state(0.0f),  //altitude_filtered
		_integ4_state(0.0f),
		_integ5_state(0.0f),   //airspeed_filtered
		_integ6_state(0.0f),  //energy_error_integ
		_integ7_state(0.0f),  //pitch_integ
